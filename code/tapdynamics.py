...
def infer_exact_G_all_timepoints(y, x, modelparameters, theta, ridge=0.0, constrained_G=False):
    """
    ...
    Inputs:
      ...
      constrained_G : bool, if True, enforce G[9:17] = 0 (only use J terms)
    ...
    if constrained_G:
        # Keep only columns 0-8 (corresponding to G[0:9])
        Phi_all = Phi_all[:, :9]
